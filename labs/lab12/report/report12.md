...
Команда let не ограничена простыми арифметическими выражениями. Табл. [табл. @tbl-121] показывает полный набор let-операций.
...
: Арифметические операторы оболочки bash {#tbl-121}
