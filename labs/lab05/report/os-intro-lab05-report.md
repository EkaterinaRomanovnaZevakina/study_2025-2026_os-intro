...
![Установка pass и pass-otp](image/л5с1.png){#fig:001 width=70%}

![Установка gopass](image/л5с2.png){#fig:002 width=70%}

### Настройка

Выполнена проверка наличия GPG-ключей и создан новый ключ для шифрования хранилища паролей (рис. -@fig:003).

![Проверка ключей GPG](image/л5с3.png){#fig:003 width=70%}

Инициализировано хранилище паролей с использованием GPG-ключа (рис. -@fig:004)

![Инициализация хранилища pass и git](image/л5с4.png){#fig:004 width=70%}

Создана git-структура (рис. -@fig:005).

![Создание структуры git](image/л5с5.png){#fig:005 width=70%}

Задан адрес репозитория на хостинге (рис. -@fig:006)

![Задание адреса репозитория на хостинге](image/л5с6.png){#fig:006 width=70%}

Выполнена синхронизация (рис. -@fig:007) и (рис. -@fig:008)

![Синхронизация](image/л5с7.png){#fig:007 width=70%}

![Синхронизация](image/л5с8.png){#fig:008 width=70%}

Выполнены прямые изменения (рис. -@fig:009)

![Прямые изменения](image/л5с9.png){#fig:009 width=70%}
